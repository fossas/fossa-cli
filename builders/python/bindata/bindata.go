...
// sources:
// builders/python/bindata/pipdeptree.py
package bindata
...
var _bindata = map[string]func() (*asset, error){
	"builders/python/bindata/pipdeptree.py": buildersPythonBindataPipdeptreePy,
}
	...
	"builders": &bintree{nil, map[string]*bintree{
		"python": &bintree{nil, map[string]*bintree{
			"bindata": &bintree{nil, map[string]*bintree{
				"pipdeptree.py": &bintree{buildersPythonBindataPipdeptreePy, map[string]*bintree{}},
			}},
		}},
	}},
}}
