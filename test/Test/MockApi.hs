...
matchExpectation _a@(AssertRevisionBinaries{}) ApiExpectation{} = Nothing
...
matchExpectation _a@(AssertUserDefinedBinaries{}) ApiExpectation{} = Nothing
...
matchExpectation _a@(FinalizeLicenseScan{}) ApiExpectation{} = Nothing
...
matchExpectation _a@(GetAnalyzedRevisions{}) ApiExpectation{} = Nothing
...
matchExpectation _a@(GetApiOpts) ApiExpectation{} = Nothing
...
matchExpectation _a@(GetAttribution{}) ApiExpectation{} = Nothing
...
matchExpectation _a@(GetIssues{}) ApiExpectation{} = Nothing
...
matchExpectation _a@(GetLatestBuild{}) ApiExpectation{} = Nothing
...
matchExpectation _a@(GetLatestScan{}) ApiExpectation{} = Nothing
...
matchExpectation _a@(GetOrganization{}) ApiExpectation{} = Nothing
...
matchExpectation _a@(GetEndpointVersion{}) ApiExpectation{} = Nothing
...
matchExpectation _a@(GetSignedLicenseScanUrl{}) ApiExpectation{} = Nothing
...
matchExpectation _a@(GetSignedUploadUrl{}) ApiExpectation{} = Nothing
...
matchExpectation _a@(QueueArchiveBuild{}) ApiExpectation{} = Nothing
...
matchExpectation _a@(ResolveProjectDependencies{}) ApiExpectation{} = Nothing
...
matchExpectation _a@(ResolveUserDefinedBinary{}) ApiExpectation{} = Nothing
...
matchExpectation _a@(UploadAnalysis{}) ApiExpectation{} = Nothing
...
matchExpectation _a@(UploadArchive{}) ApiExpectation{} = Nothing
...
matchExpectation _a@(UploadContainerScan{}) ApiExpectation{} = Nothing
...
matchExpectation _a@(UploadContributors{}) ApiExpectation{} = Nothing
...
matchExpectation _a@(UploadLicenseScanResult{}) ApiExpectation{} = Nothing
...
matchExpectation _a@(AddFilesToVsiScan{}) (ApiExpectation{}) = Nothing
...
matchExpectation _a@(CompleteVsiScan{}) (ApiExpectation{}) = Nothing
...
matchExpectation _a@(CreateVsiScan{}) (ApiExpectation{}) = Nothing
...
matchExpectation _a@(GetVsiInferences{}) (ApiExpectation{}) = Nothing
...
matchExpectation _a@(GetVsiScanAnalysisStatus{}) (ApiExpectation{}) = Nothing
