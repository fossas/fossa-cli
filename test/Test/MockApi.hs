...
matchExpectation _a@(AssertRevisionBinaries{}) (ApiExpectation _ ExpectingExactRequest _ _) = RequestUnsatisfied
...
matchExpectation _a@(AssertUserDefinedBinaries{}) (ApiExpectation _ ExpectingExactRequest _ _) = RequestUnsatisfied
...
matchExpectation _a@(FinalizeLicenseScan{}) (ApiExpectation _ ExpectingExactRequest _ _) = RequestUnsatisfied
...
matchExpectation _a@(GetApiOpts{}) (ApiExpectation _ ExpectingExactRequest _ _) = RequestUnsatisfied
...
matchExpectation _a@(GetAttribution{}) (ApiExpectation _ ExpectingExactRequest _ _) = RequestUnsatisfied
...
matchExpectation _a@(GetIssues{}) (ApiExpectation _ ExpectingExactRequest _ _) = RequestUnsatisfied
...
matchExpectation _a@(GetLatestBuild{}) (ApiExpectation _ ExpectingExactRequest _ _) = RequestUnsatisfied
...
matchExpectation _a@(GetLatestScan{}) (ApiExpectation _ ExpectingExactRequest _ _) = RequestUnsatisfied
...
matchExpectation _a@(GetOrganization{}) (ApiExpectation _ ExpectingExactRequest _ _) = RequestUnsatisfied
...
matchExpectation _a@(GetProject{}) (ApiExpectation _ ExpectingExactRequest _ _) = RequestUnsatisfied
matchExpectation a@(GetScan{}) (ApiExpectation _ requestExpectation b@(GetScan{}) resp) = checkResult requestExpectation a b resp
matchExpectation _a@(GetScan{}) (ApiExpectation _ ExpectingExactRequest _ _) = RequestUnsatisfied
...
matchExpectation _a@(GetSignedLicenseScanUrl{}) (ApiExpectation _ ExpectingExactRequest _ _) = RequestUnsatisfied
...
matchExpectation _a@(GetSignedUploadUrl{}) (ApiExpectation _ ExpectingExactRequest _ _) = RequestUnsatisfied
...
matchExpectation _a@(QueueArchiveBuild{}) (ApiExpectation _ ExpectingExactRequest _ _) = RequestUnsatisfied
...
matchExpectation _a@(ResolveProjectDependencies{}) (ApiExpectation _ ExpectingExactRequest _ _) = RequestUnsatisfied
...
matchExpectation _a@(ResolveUserDefinedBinary{}) (ApiExpectation _ ExpectingExactRequest _ _) = RequestUnsatisfied
...
matchExpectation _a@(UploadAnalysis{}) (ApiExpectation _ ExpectingExactRequest _ _) = RequestUnsatisfied
...
matchExpectation _a@(UploadArchive{}) (ApiExpectation _ ExpectingExactRequest _ _) = RequestUnsatisfied
...
matchExpectation _a@(UploadContainerScan{}) (ApiExpectation _ ExpectingExactRequest _ _) = RequestUnsatisfied
...
matchExpectation _a@(UploadContributors{}) (ApiExpectation _ ExpectingExactRequest _ _) = RequestUnsatisfied
...
matchExpectation _a@(UploadLicenseScanResult{}) (ApiExpectation _ ExpectingExactRequest _ _) = RequestUnsatisfied
matchExpectation _ _ = RequestUnmocked
