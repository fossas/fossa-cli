...
spec = do
  ...
  describe "content is binary" $ do
    ...
    it "fingerprints raw correctly" $ case result of
      Left _ -> expectationFailure "could not fingerprint"
      Right c -> (toText . combinedRaw $ c) `shouldBe` "a57d87677b2b67c573c870aff75d8c92c23beaf9f8682e7749ba7b421e84c991"
  ...
  describe "content is empty" $ do
    ...
    it "fingerprints raw correctly" $ case result of
      Left _ -> expectationFailure "could not fingerprint"
      Right c -> (toText . combinedRaw $ c) `shouldBe` "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855"
  ...
  describe "single line file" $ do
    ...
    it "fingerprints raw correctly" $ case result of
      Left _ -> expectationFailure "could not fingerprint"
      Right c -> (toText . combinedRaw $ c) `shouldBe` "deac66ccb79f6d31c0fa7d358de48e083c15c02ff50ec1ebd4b64314b9e6e196"
  ...
  describe "single line file with comment" $ do
    ...
    it "fingerprints raw correctly" $ case result of
      Left _ -> expectationFailure "could not fingerprint"
      Right c -> (toText . combinedRaw $ c) `shouldBe` "7bf434baac2af7cf06fea2125d453f7b14cf942d5b3cef2a4a2a9281eec2534b"
  ...
  describe "multi line file" $ do
    ...
    it "fingerprints raw correctly" $ case result of
      Left _ -> expectationFailure "could not fingerprint"
      Right c -> (toText . combinedRaw $ c) `shouldBe` "8bd20ac94646806aec6dadb9325218718d1ba8abc039da6abc9aa8159658671d"
