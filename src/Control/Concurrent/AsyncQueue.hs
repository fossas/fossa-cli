...
module Control.Concurrent.AsyncQueue (
  AsyncQueue,
  newQ,
  writeToQ,
  closeQ,
...
-- @asyncQueueProcessor.
closeQ :: AsyncQueue a -> IO (Maybe SomeException)
closeQ AsyncQueue{..} = do
