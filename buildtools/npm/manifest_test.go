...
func testFromNodeModulesByFixture(t *testing.T, fixture string) {
	...
	*/
	...
	assert.True(t, ContainsImport(chaiProject.Imports, "pathval", "1.1.0"), "missing assertion-error@1.1.0")
	assert.True(t, ContainsImport(chaiProject.Imports, "type-detect", "4.0.8"), "missing assertion-error@1.1.0")
}
