...
poetry =
  AnalysisTestFixture
    ...
    LocalEnvironment
    Nothing
    $ FixtureArtifact "https://github.com/python-poetry/poetry/archive/72497bcb66b5a1cc20e3aa95973c523a22b05bfa.tar.gz" [reldir|python/poetry/poetry/|] (Just [reldir|poetry-72497bcb66b5a1cc20e3aa95973c523a22b05bfa/|])
