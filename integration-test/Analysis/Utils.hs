...
import Graphing (countEdges, directList, vertexList)
...
data AnalysisIntegrationCategory
  = AnalysisIntegrationPython
  | AnalysisIntegrationElixir
  deriving (Eq, Ord)

instance Show AnalysisIntegrationCategory where
  show (AnalysisIntegrationPython) = show ("Python" :: Text)
  show (AnalysisIntegrationElixir) = show ("Elixir" :: Text)

data AnalysisIntegrationCase a = AnalysisIntegrationCase
  { testCategory :: AnalysisIntegrationCategory
  , testName :: Text
