...
- [Documentation](#documentation)
  ...
  - [Container image analysis](#container-image-analysis)
    ...
    - [Container Go binary analysis](#container-go-binary-analysis)
...
The container analyzer inspects executable files in each layer and reports the Go modules
embedded in any Go binaries it finds.
